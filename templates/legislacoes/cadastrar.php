<div class="container-fluid mt-3">
    ...
    <div class="row">
        ...
        <form method="POST" name="nFormLegislacao" enctype="multipart/form-data">
            <input type="hidden" id="iCod" value="<?php echo (!empty($arrayCad['id'])) ? $arrayCad['id'] : ''; ?>">
            <div class="col">
                <div class="card">
                        ...
                        <div class="row">
                                ...
                                <select class="form-select" id="iCategoria" name="nCategoria" required>
                                    ...
                                    <?php if (isset($categoria) && !empty($categoria)) {
                                        foreach ($categoria as $index) {
                                            if (isset($arrayCad['categoria']) && $arrayCad == $index['categoria']) {
                                ...
                                <select class="form-select" id="iEsfera" name="nEsfera" required>
                                    ...
                                    <?php if (isset($esfera) && !empty($esfera)) {
                                        foreach ($esfera as $index) {
                                            if (isset($arrayCad['esfera']) && $arrayCad == $index['esfera']) {
                            ...
                            <div class="col-md-2 mt-1">
                                ...
                                <input type="text" class="form-control input-numero_lei" id="iNumero" name="nNumero"
                                    placeholder="Exemplo: 041" required>
                                <div class="invalid-feedback">
                                    Informe o número
                                </div>
                            </div>
                            <div class="col-md-2 mt-1">
                                ...
                                <input type="text" class="form-control input-ano" id="iAno" name="nAno"
                                    placeholder="Exemplo: 2015" required>
                                <div class="invalid-feedback">
                                    Informe o ano
                                </div>
                            </div>
                            <div class="col-md-2 mt-1">
                                ...
                                <input type="text" class="form-control date_serach input-data" id="iData" name="nData"
                                    placeholder="Exmplo: 02/10/2015" required>
                                <div class="invalid-feedback">
                                    Informe a data
                                </div>
                            </div>
                            <div class="col-md-12 mt-3">
                                ...
                                <textarea name="nEmenta" id="iEmenta" rows="5" class="form-control" required></textarea>
                                <div class="invalid-feedback">
