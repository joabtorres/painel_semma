...
function validarFormLogin() {
   ...
   if (null_or_empty("iUsuario") || null_or_empty("iSenha")) {
...
function validarFormUsuario() {
   ...
   let rsenha = document.querySelector("#iRSenha");
   if (
      null_or_empty("iNome") ||
...
if (document.getElementById("usuario-form")) {
   ...
   $(function () {
      $("#imagemPadrao").click(function () {
         $("#imageUser").css(
            "background-image",
            'url("' + base_url + '/assets/image/user.png")'
         );
